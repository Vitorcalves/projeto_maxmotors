...
<body>
    ...
    <div class="container" class="mt-2">
        ...
        <form method="POST" action="<?= baseUrl() ?>produto/insert" enctype="multipart/form-data" class="row g-3">
            ...
            <div class="col-md-8    ">
                ...
                <div class="form-floating">
                    <textarea class="form-control" placeholder="Informe uma descricãp" id="descricao" style="height: 100px; resize: none" name="descricao"></textarea>

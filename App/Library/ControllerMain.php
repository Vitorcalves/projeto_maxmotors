...
class ControllerMain
{
	...
	{
		error_log("Dados POST: " . print_r($this->dados, true));
	...
	/**
	 * Converte dados para JSON e envia uma resposta HTTP
	 *
	 * @param array $data
	...
	public function toJson($data, $status = 200)
	{
		...
		echo json_encode($data); // Converte os dados para JSON e os exibe
		exit; // Encerra a execução para evitar envio de dados adicionais
	}
}
